...
We use the \emph{Web of Lies} task from BBH~\citep{srivastava2023beyond} to test multi-step boolean composition. Each example presents a chain of five assertions of the form ``A says B [does/does not] tell the truth,'' followed by a query asking whether a named person tells the truth. The correct answer (\texttt{yes} or \texttt{no}) depends on whether an even or odd number of negations compose across the chain.
